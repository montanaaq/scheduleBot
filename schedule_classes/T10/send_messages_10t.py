...
async def send_message_cron():
    ...
    for user in users_first:
        if datetime.now().weekday() == 0:
            await main.bot.send_message(chat_id=user, text=(await msg_10t_1.return_schedule('monday')), parse_mode='html')
        if datetime.now().weekday() == 1:
            await main.bot.send_message(chat_id=user, text=(await msg_10t_1.return_schedule('tuesday')), parse_mode='html')
        if datetime.now().weekday() == 2:
            await main.bot.send_message(chat_id=user, text=(await msg_10t_1.return_schedule('wednesday')), parse_mode='html')
        if datetime.now().weekday() == 3:
            await main.bot.send_message(chat_id=user, text=(await msg_10t_1.return_schedule('thursday')), parse_mode='html')
        if datetime.now().weekday() == 4:
            await main.bot.send_message(chat_id=user, text=(await msg_10t_1.return_schedule('friday')), parse_mode='html')
        if datetime.now().weekday() == 5:
            await main.bot.send_message(chat_id=user, text=(await msg_10t_1.return_schedule('saturday')), parse_mode='html')
    for user_2 in users_second:
        if datetime.now().weekday() == 0:
            await main.bot.send_message(chat_id=user_2, text=(await msg_10t_2.return_schedule('monday')), parse_mode='html')
        if datetime.now().weekday() == 1:
            await main.bot.send_message(chat_id=user_2, text=(await msg_10t_2.return_schedule('tuesday')), parse_mode='html')
        if datetime.now().weekday() == 2:
            await main.bot.send_message(chat_id=user_2, text=(await msg_10t_2.return_schedule('wednesday')), parse_mode='html')
        if datetime.now().weekday() == 3:
            await main.bot.send_message(chat_id=user_2, text=(await msg_10t_2.return_schedule('thursday')), parse_mode='html')
        if datetime.now().weekday() == 4:
            await main.bot.send_message(chat_id=user_2, text=(await msg_10t_2.return_schedule('friday')), parse_mode='html')
        if datetime.now().weekday() == 5: 
            await main.bot.send_message(chat_id=user_2, text=(await msg_10t_2.return_schedule('saturday')), parse_mode='html')
